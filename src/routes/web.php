...
Route::resource('/dashboard/data-kompetensi', 'KompetensiKeahlianController');
...
Route::get('/dashboard/siswa/profile', 'SiswaLoginController@profileSiswa');
Route::get('/dashboard/siswa/{id}/edit', 'SiswaLoginController@edit');
Route::put('/dashboard/siswa/{id}/edit', 'SiswaLoginController@update');
