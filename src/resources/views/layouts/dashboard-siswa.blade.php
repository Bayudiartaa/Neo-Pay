            ...
            <nav class="navbar top-navbar navbar-expand-md "style="background-color: #ae7d59;">
                <div class="navbar-header" data-logobg="skin5" >
                    ...
                    <a class="navbar-brand" href="{{ url('/dashboard') }}" style="background-color: #ae7d59;">                                            
                        ...
                        <span class="logo-text font-weight-bold text-dark ml-2">                          
						 E-Pembayaran SPP                             
                        </span>
                    </a>
                    <!-- ============================================================== -->
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <div class="user-profile d-flex no-block dropdown">
                            <a href="javascript:void(0)" class="" id="Userdd" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <h5 class="m-b-0 user-name font-medium text-dark">{{ session('nama') }}<i class="ml-2 fa fa-angle-down"></i></h5>
                                <span class="op-5 user-email text-dark">NISN : {{ session('nisn') }}</span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                <a class="dropdown-item" href="{{ url('siswa/logout')}}"><i class="mdi mdi-logout mdi-24px m-r-5 m-l-5"></i> Logout</a>
                            </div>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ url('dashboard/siswa/histori') }}" aria-expanded="false"><i class="mdi mdi-note-multiple"></i><span class="hide-menu">History</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ url('dashboard/siswa/profile') }}" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span class="hide-menu">Profile</span></a></li>
